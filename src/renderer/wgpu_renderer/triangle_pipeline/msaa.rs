    ...
    pub fn new(
        ...
        let uniforms_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                label: Some("goldenrod::triangle:msaa uniforms layout"),
        ...
        let uniforms_bind_group =
            device.create_bind_group(&wgpu::BindGroupDescriptor {
                label: Some("goldenrod::triangle::msaa uniforms bind group"),
        ...
        let texture_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                label: Some("goldenrod::triangle::msaa texture layout"),
                entries: &[wgpu::BindGroupLayoutEntry {
                    binding: 0,
                    visibility: wgpu::ShaderStage::FRAGMENT,
        ...
        let pipeline_layout =
            device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                label: Some("goldenrod::triangle::msaa pipeline layout"),
        ...
        let pipeline =
            device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
                label: Some("goldenrod::triangle::msaa pipeline"),
...
impl Targets {
    pub fn new(
        ...
        let attachment = device.create_texture(&wgpu::TextureDescriptor {
            label: Some("goldenrod::triangle::msaa attachment"),
            size: extent,
            mip_level_count: 1,
            sample_count,
        ...
        let resolve = device.create_texture(&wgpu::TextureDescriptor {
            label: Some("goldenrod::triangle::msaa resolve target"),
            size: extent,
            mip_level_count: 1,
            sample_count: 1,
            dimension: wgpu::TextureDimension::D2,
        ...
        let bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("goldenrod::triangle::msaa texture bind group"),
